...
#
##
# Imports classifier function for using CNN to classify images, imports os 
...
def classify_images(images_dir, results_dic, model):
    ...
    for filename, label_list in results_dic.items():
        ...
        # Use the classifier function to get the predicted label
        classifier_label = classifier(full_image_path, model).lower().strip()
        ...
        # Append the classifier label and the match result to the results dictionary
