...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_dogs_img'] = sum([item[3] for item in results_dic.values()])
    ...
    # Calculate the number of correct dog matches
    results_stats_dic['n_correct_dogs'] = sum([item[3] == 1 and item[4] == 1 for item in results_dic.values()])

    # Calculate the number of correct non-dog matches
    results_stats_dic['n_correct_notdogs'] = sum([item[3] == 0 and item[4] == 0 for item in results_dic.values()])

    # Calculate the number of correct breed matches
    results_stats_dic['n_correct_breed'] = sum([item[3] == 1 and item[2] == 1 for item in results_dic.values()])

    # Calculate the number of label matches (pet label matches classifier label)
    results_stats_dic['n_match'] = sum([item[2] for item in results_dic.values()])

    # Calculate the percentage of correct dog classifications
    ...
    # Calculate the percentage of correct breed classifications
    ...
    # Calculate the percentage of correct non-dog classifications
    ...
    # Calculate the percentage of label matches
    ...
    # Return the results_stats_dic dictionary that was created
